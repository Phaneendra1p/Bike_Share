...
```
> [comparing members and casuals by ride length](https://github.com/Phaneendra1p/Bike_Share/blob/main/Comparing%20members%20and%20casuals%20by%20ride%20length.png)
...
```
> [average ride length of members and casuals by weekday](https://github.com/Phaneendra1p/Bike_Share/blob/main/Comparing%20members%20and%20casual%20users%20by%20weekday.png)
...
aggregate(all_trips_v3$ride_length ~ all_trips_v3$member_casual + all_trips_v3$day_of_week, FUN = mean)
```
> [average ride length of members and casuals by weekday ordered](https://github.com/Phaneendra1p/Bike_Share/blob/main/Comparing%20members%20and%20casual%20users%20by%20weekday%20ordered.png)
...
```
> [analyze ridership data by type and weekday](https://github.com/Phaneendra1p/Bike_Share/blob/main/analyze%20ridership%20data%20by%20type%20and%20weekday.png)
...
```
> [weekday vs number of rides](https://github.com/Phaneendra1p/Bike_Share/blob/main/number%20of%20rides%20vs%20weekday.png)
...
all_trips_v3 %>% 
  ...
  geom_col(position = "dodge")
```
> [weekday vs average ride duration](https://github.com/Phaneendra1p/Bike_Share/blob/main/average%20duration%20vs%20weekday.png)
